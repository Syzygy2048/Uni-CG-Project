...
std::string GLDebug::formatDebugOutput(GLenum source, GLenum type, GLuint id, GLenum severity, const char* msg){
...
void APIENTRY GLDebug::debugCallbackAMD(GLuint id, GLenum category, GLenum severity, GLsizei length, const GLchar* message, GLvoid* userParam) {
...
void GLDebug::registerDebugCallbacks(){
